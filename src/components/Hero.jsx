...
const Hero = ({ className }) => {
  return (
    <div
      className={`flex relative ${className} min-h-[30vh] xl:min-h-[50vh] bg-neutral-lightgray bg-[url(/assets/bg-intro-mobile.svg)] lg:bg-[url(/assets/bg-intro-desktop.svg)] bg-contain lg:bg-[length:auto_60vw] bg-no-repeat lg:bg-[center_right_-25vw] z-0 py-8 px-8 md:px-16 lg:py-32`}
    >
      <div className="w-full max-w-[1200px] flex flex-col flex-col-reverse items-center lg:items-start gap-4">
